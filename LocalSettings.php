...
$wgLogo = '/mediawiki/images/logo.jpg';
...
$wgEmergencyContact = $_ENV['MW_ADMIN_EMAIL'];
$wgPasswordSender = $_ENV['MW_ADMIN_EMAIL'];
...
# Semantic Mediawiki
require_once("$IP/vendor/mediawiki/validator/Validator.php" );
require_once("$IP/vendor/mediawiki/semantic-media-wiki/SemanticMediaWiki.php");
require_once("$IP/vendor/mediawiki/semantic-result-formats/SemanticResultFormats.php");
include_once("$IP/vendor/mediawiki/semantic-compound-queries/SemanticCompoundQueries.php");
enableSemantics($wgServer);

# Semantic maps extension
require_once("$IP/vendor/mediawiki/maps/Maps.php");
